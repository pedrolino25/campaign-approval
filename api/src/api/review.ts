...
import * as v1 from './v1/handlers/review.js'

const routes: RouteDefinition[] = [
  RouteBuilder.get(
    '/review-items', 
    v1.handleGetReviewItems, 
    ApiVersion.V1
  ),
  RouteBuilder.post(
    '/review-items', 
    v1.handlePostReviewItems, 
    ApiVersion.V1
  ),
  RouteBuilder.get(
    '/review-items/:id', 
    v1.handleGetReviewItem, 
    ApiVersion.V1
  ),
  RouteBuilder.post(
    '/review-items/:id/send', 
    v1.handleSendReviewItem, 
    ApiVersion.V1
  ),
  RouteBuilder.post(
