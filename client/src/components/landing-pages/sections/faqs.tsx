  ...
  return (
    <section className="container relative py-[60px] flex items-center justify-center">
      ...
      <div className="flex flex-col gap-10 w-full max-w-full md:max-w-[540px]">
        <h2 className="text-h3 md:text-[32px] font-medium text-black/80">
        ...
        >
          {faqs.map((item, i) => (
            ...
            >
              <AccordionTrigger className="text-[18px] font-medium text-start text-black/80 hover:no-underline">
                {item.title}
              </AccordionTrigger>
        ...
        <ButtonLink
          ...
          variant="outline"
          size="sm"
          className="group/hero-button gap-2 w-fit"
        >
