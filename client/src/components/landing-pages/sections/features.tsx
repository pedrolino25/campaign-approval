      ...
      <div className="w-full flex gap-20 items-stretch">
        <div className="w-full md:w-[40%] flex flex-col gap-6 justify-center">
          <div className="w-full flex flex-col gap-6">
            ...
            <h2 className="text-h3 lg:text-h2 text-black/80">Your Campaign Approval System</h2>

            <p className="text-body text-black/80">
              An integrated approval platform built to manage campaign reviews at scale. From
              version control to final sign-off, it brings clarity and operational discipline to
            ...
            <ButtonLink
              ...
              size="sm"
              variant="outline"
              className="group/features gap-2 w-fit"
            >
            ...
            {features.map((_, i) => (
              <div
                ...
                className={`h-[4px] w-[14px] rounded-[22px] transition-colors duration-300 ${
                  active === String(i) ? 'bg-[#c4c5f4]' : 'bg-black/10'
                }`}
              />
            ))}
          </div>
        ...
        <div className="min-h-[650px] w-[60%] hidden md:block">
          <FeatureImage
            theme="purple"
            imageSrc={features[parseInt(active)].image}
          />
        </div>
      </div>
    </section>
