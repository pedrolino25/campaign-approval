...
export const FeatureImage = ({ theme, imageSrc }: FeatureImageProps) => {
...
export const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        'bg-[#f7f7f7] rounded-md p-5 lg:p-10 flex flex-col-reverse sm:flex-row items-stretch gap-10 border border-[#f0f0f0]',
    ...
    >
      ...
      <div className="w-full sm:w-[50%] lg:w-[400px] shrink-0 flex flex-col justify-center gap-4 text-start">
        ...
        <ButtonLink
          ...
          variant="outline"
          size="sm"
          className="group/feature gap-2 w-fit"
        >
