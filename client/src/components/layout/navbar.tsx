  ...
  return (
    <div className="relative group">
      ...
      <nav className="z-20 fixed top-0 left-0 w-full flex justify-center items-center max-md:bg-white md:bg-[linear-gradient(rgb(255,255,255)_0%,rgb(255,255,255)_61%,rgba(0,0,0,0)_100%)] pt-3 px-5 pb-3 md:pb-10">
        <div className="container px-0 w-full flex justify-between items-center">{children}</div>
      </nav>
...
const MenuLinkItem = ({ title, description, Icon, href, color }: MenuLinkItemProps) => {
  return (
    <a
      href={href}
...
const MobileMenuLinkItem = ({ title, description, Icon, href }: MobileMenuLinkItemProps) => {
  return (
    <a
      href={href}
...
const NavbarMobileMenu = ({ hasSession }: { hasSession: boolean }) => {
  return (
    <div
      className="
    ...
    >
      <div className="flex flex-col p-6 gap-4 text-lg">
        <div className="relative">
          ...
          >
            <p className="font-medium text-2xl text-[#000000cc]">Product</p>
          </label>
          <ChevronDownIcon
            className="
        ...
        <a
          href="/pricing"
          className="font-medium text-2xl text-[#000000cc]"
        >
          Pricing
        </a>
        {hasSession ? (
