...
import operationalVisibilityPoster from "@/assets/heros/operational-visibility-poster.png";
  ...
  return (
    <Hero.Root>
        <Hero.Background
            ...
            videoSrc={[{ src: '/hero-videos/operational_visibility.mp4', type: 'video/mp4' }]}
            imageSrc={operationalVisibilityPoster}
        />
