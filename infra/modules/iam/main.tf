...
resource "aws_iam_role" "organization" {
  name = "${local.environment_prefix}organization-api-role"
...
resource "aws_iam_role_policy" "organization" {
  name = "${local.environment_prefix}organization-api-policy"
  role = aws_iam_role.organization.id
...
resource "aws_iam_role" "review" {
  name = "${local.environment_prefix}review-api-role"
...
resource "aws_iam_role_policy" "review" {
  name = "${local.environment_prefix}review-api-policy"
...
resource "aws_iam_role" "attachment" {
  name = "${local.environment_prefix}attachment-api-role"
...
resource "aws_iam_role_policy" "attachment" {
  name = "${local.environment_prefix}attachment-api-policy"
  role = aws_iam_role.attachment.id
...
resource "aws_iam_role" "comment" {
  name = "${local.environment_prefix}comment-api-role"
...
resource "aws_iam_role_policy" "comment" {
  name = "${local.environment_prefix}comment-api-policy"
